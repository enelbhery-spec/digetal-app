...
export const metadata: Metadata = {
  title: "مقالات تطبيق Smart Search | بديل البحث التقليدي",
  description:
    "مقالات تشرح فكرة تطبيق Smart Search وكيف يساعدك في الوصول السريع إلى الخطوط الساخنة والخدمات والمتاجر بدل البحث التقليدي المرهق.",
  keywords: [
    "البحث الذكي",
    "Smart Search",
    "الخط الساخن",
...
const articles = [
  {
    ...
    desc: "مقارنة واقعية بين الطرق القديمة للبحث عن أرقام الخدمات والطريقة الذكية عبر Smart Search.",
    ...
    <main className="max-w-6xl mx-auto px-4 py-14" dir="rtl">
      ...
      <section className="mt-16 bg-gradient-to-r from-green-50 to-emerald-50 p-8 rounded-2xl text-center border">
        ...
        <p className="text-gray-700 mb-6 max-w-2xl mx-auto">
          ...
          استخدم Smart Search للوصول إلى المعلومة الصحيحة في ثوانٍ.
        </p>
