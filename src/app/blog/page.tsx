...
export const metadata: Metadata = {
  title: "مدونة البحث الذكى | البحث الذكي عن حدمة العملاء ",
  description:
    "مقالات ودلائل تساعدك على البحث الذكي عن خدمة العملاء، الخدمات، المتاجر، والتطبيقات بدل الطرق التقليدية المرهقة.",
};

const categories = [
  {
    title: "📱 مقالات التطبيق",
    desc: " خدمات البحث الذكى وكيف تحل مشكلات بحث جوجل",
    link: "/blog/app",
  },
  {
    title: "📘 الأدلة والمقارنات",
    desc: "مقارنات بين بحث جوجل والبحث الذكي",
    ...
    <main className="max-w-6xl mx-auto p-4" dir="rtl">
      ...
      <section className="text-center mb-10">
        ...
        <p className="text-gray-600 text-lg">
          دليلك العملي للبحث الذكي عن خدمة العملاء، الخدمات، والمتاجر
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <article className="border rounded-xl p-4 bg-white">
            <h3 className="font-bold mb-2">
              خدمة العملاء: من بحث جوجل إلى البحث الذكي
            </h3>
          ...
          <article className="border rounded-xl p-4 bg-white">
            <h3 className="font-bold mb-2">
              لماذا يفشل بحث جوجل عن خدمة العملاء؟
            </h3>
            <p className="text-sm text-gray-600 mb-3">
          ...
          <article className="border rounded-xl p-4 bg-white">
            <h3 className="font-bold mb-2">
              بحث جوجل أم البحث الذكى؟ من الافضل
            </h3>
            <p className="text-sm text-gray-600 mb-3">
